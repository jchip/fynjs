...
import { TRUSTED_URL_TYPES, getSourceUrlType } from "./lifecycle-script-policy";
 ...
 */
export function isNonRegistryUrlType(urlType) {
 ...
 */
export function isValidRegistrySpec(spec) {
 ...
 */
export function violatesRegistryPolicy(dep) {
