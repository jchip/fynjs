...
import { getPackInfo, metaFileOf, writePkgFile } from "./utils.js";
/**
...
export async function postPack() {
    ...
    try {
        ...
        const meta = await Fs.readFile(metaFile, "utf8").then(data => JSON.parse(data), () => undefined);
        const target = (meta === null || meta === void 0 ? void 0 : meta.pkgFile) || pkgFile;
        if ((meta === null || meta === void 0 ? void 0 : meta.pkgFile) && meta.pkgFile !== pkgFile) {
